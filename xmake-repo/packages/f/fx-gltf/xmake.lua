package("fx-gltf")
    ...
    set_urls("https://github.com/jessey-git/fx-gltf/archive/refs/tags/v$(version).tar.gz")

    add_versions("1.2.0", "d8eaceba72ea6574b982c7b0d2328fd3f8ad519db4a37cf63cd3f8020d7722bf")
    ...
    on_test(function(pkg)
        ...
        ]]}, {configs = {languages = "c++17"}, includes = "fx/gltf.h"}))
    end)
